...
const Signin = () => {
  ...
  const handleSubmit = async (values, { setSubmitting, resetForm }) => {
    try {
      const signedInUser = await authstore.getState().signin(values);

      if (signedInUser) {
        await AsyncStorage.setItem('auth-storage', JSON.stringify(signedInUser));
        Alert.alert('Success', 'Signin successful');
        resetForm();
        // Use replace to avoid navigation errors before RootLayout mounts
